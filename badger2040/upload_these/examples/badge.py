...
def draw_badge():
    ...
    display.set_pen(15)
    display.rectangle(0, 0, TEXT_WIDTH + 1, COMPANY_HEIGHT + 2)

    # Draw the company
    display.set_pen(0)  # Change this to 15 if a black background is used
    display.set_font("sans")
    display.text(company, LEFT_PADDING, (COMPANY_HEIGHT // 2) + 1, WIDTH, COMPANY_TEXT_SIZE)

    # Draw a white background behind the name
    display.set_pen(15)
    display.rectangle(0, COMPANY_HEIGHT + 2, TEXT_WIDTH + 1, NAME_HEIGHT)
...
company = badge.readline()        # "Auth0 by Okta"
name = badge.readline()           # "Developer"
detail1_title = badge.readline()  # "Devday@Oktane"
detail1_text = badge.readline()   # ""
detail2_title = badge.readline()  # "@developer"
